	...
	<div>
		...
		<div id="slider1" class="swipe">
			<ul class="box01_list">
				...
				<li class="li_list" style="background:#b16b40">
					<span>line1</span>
					<span>line2</span>
					<span>line3</span>
					<span>line4</span>
				...
				<li class="li_list" style="background:#4053b1">
					<span>line1</span>
					<span>line2</span>
					<span>line3</span>
					<span>line4</span>
				...
				<li class="li_list" style="background:#b14080">
					<span>line1</span>
					<span>line2</span>					
				</li>
				<li class="li_list" style="background:#4dd1b3">
					<span>line1</span>
					<span>line2</span>
					<span>line3</span>					
				</li>
				<li class="li_list" style="background:#bea30e">
					<span>line1</span>
					<span>line2</span>
					<span>line3</span>
					<span>line4</span>					
...
<script>
	import touchSl from './touchslider.js';
	export default {
		name: 'phoneTap',
		data() {
			return {
